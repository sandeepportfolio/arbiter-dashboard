...
# Load extended crypto/finance seed records if available.
# market_seeds_ext.py is generated by scripts/discover_markets.py + scripts/generate_seeds.py.
# All records in the ext file have status='candidate' and allow_auto_trade=False —
# they never affect live trading until an operator explicitly promotes them.
try:
